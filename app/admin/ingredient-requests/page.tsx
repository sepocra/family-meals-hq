            ...
            >
              ...
              <div className="flex flex-wrap gap-2">
                <button
                  ...
                  className="text-sm font-medium bg-gray-900 text-white dark:bg-gray-100 dark:text-gray-900 rounded-lg px-3 py-1.5 hover:bg-gray-700 dark:hover:bg-gray-300 disabled:opacity-50"
                >
